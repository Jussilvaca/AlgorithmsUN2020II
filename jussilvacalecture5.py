...
start_2 = '2014-01-01'
end_2 = '2015-01-01'
data_2 = get_pricing(['AAPL', 'MSFT'], fields='price', start_date=start_2, end_date=end_2)
data_2.head()
...
data_2.columns = [e.symbol for e in data_2.columns]
data_2.head()
...
# Plot a histogram using 20 bins
plt.hist(R_2, bins=20, cumulative=True)
plt.xlabel('Return')
plt.ylabel('Number of Days Observed')
plt.title('Cumulative Distribution of MSFT Returns, 2014');
...
plt.scatter(data_2['MSFT'], data_2['AAPL'])
plt.xlabel('MSFT')
plt.ylabel('AAPL')
plt.title('Daily Prices in 2014');
...
R_msft_2 = data_2['MSFT'].pct_change()[1:]
R_aapl_2 = data_2['AAPL'].pct_change()[1:]

plt.scatter(R_msft_2, R_aapl_2)
plt.xlabel('MSFT')
plt.ylabel('AAPL')
plt.title('Daily Returns in 2014');
...
plt.plot(data_2['MSFT'])
plt.plot(data_2['AAPL'])
plt.ylabel('Price')
plt.legend(['MSFT', 'AAPL']);
